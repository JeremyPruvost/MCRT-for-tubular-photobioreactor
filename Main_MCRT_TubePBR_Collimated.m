...
%%%% collimated (direct) part of the sunlight
...
[gamma,LRPA,LRPA_gamma,q_PFD] = MCRT_Collimated_fun(INPUTS);
...
%%%%%%%%%%%%% Information related to calculation sensitivity toward grid refinement
